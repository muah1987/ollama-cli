...
def cmd_accelerate_check(_args: argparse.Namespace) -> None:
    ...
    console.print("  Use 'ollama-cli exo discover' to find cluster nodes")
    ...
    try:
        ...
        if result.returncode == 0 and result.stdout.strip():
            ...
            console.print("  Use 'ollama-cli rdma detect' to list devices")
        else:
...
def cmd_accelerate_enable(args: argparse.Namespace) -> None:
    ...
    if method == "mlx":
        ...
        if device:
            ...
            console.print("Use 'ollama-cli rdma connect <device>' to connect")
    elif method == "exo":
...
def cmd_accelerate(_args: argparse.Namespace) -> None:
    ...
    console.print("  ollama-cli accelerate check")
    console.print("  ollama-cli accelerate enable mlx")
    console.print("  ollama-cli accelerate enable rdma")
    console.print("  ollama-cli accelerate disable")
