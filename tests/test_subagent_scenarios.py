...
class TestNestedSubAgentScenarios:
    ...
    def test_hierarchical_agent_token_tracking(self):
        ...
        sub_response1 = {"usage": {"input_tokens": 500, "output_tokens": 1000}, "response_ms": 500}
        sub_agent1.update(sub_response1)

        # Sub-agent 2
        sub_agent2 = TokenCounter(provider="anthropic")
        sub_response2 = {"usage": {"input_tokens": 300, "output_tokens": 700}, "response_ms": 300}
    ...
    def test_multi_level_nested_agents(self):
        ...
        for i, worker in enumerate(workers):
            response = {
                "usage": {"input_tokens": base_input * (i + 1), "output_tokens": base_output * (i + 1)},
                "response_ms": 100 * (i + 1),
            }
        ...
        coordinator1.update(
            {"usage": {"input_tokens": coord1_input, "output_tokens": coord1_output}, "response_ms": 300}
        )
        ...
        coordinator2.update(
            {"usage": {"input_tokens": coord2_input, "output_tokens": coord2_output}, "response_ms": 400}
        )
        ...
        master.update({"usage": {"input_tokens": master_input, "output_tokens": master_output}, "response_ms": 500})
    ...
    def test_subagent_cost_aggregation(self):
        ...
        # Simulate usage
        claude_response = {"usage": {"input_tokens": 1000, "output_tokens": 2000}, "response_ms": 1000}
        agent_claude.update(claude_response)

        openai_response = {"usage": {"prompt_tokens": 1500, "completion_tokens": 2500}, "request_latency_ms": 800}
        agent_openai.update(openai_response)

        gemini_response = {"prompt_token_count": 800, "candidates": [{"token_count": 1200}], "total_latency": 0.6}
