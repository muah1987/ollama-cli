...
class TestTokenCounterProviders:
    ...
    def test_anthropic_provider_token_extraction(self):
        ...
        response = {
            "usage": {"input_tokens": 300, "output_tokens": 750},
    ...
    def test_codex_provider_cost_calculation(self):
        ...
        counter.cost_estimate = counter._estimate_cost(counter.provider)
...
class TestTokenCounterEdgeCases:
    ...
    def test_zero_tokens(self):
        ...
        response = {"usage": {"prompt_tokens": 0, "completion_tokens": 0}, "request_latency_ms": 0}
    ...
    def test_maximum_context_limits(self):
        ...
        response = {"usage": {"input_tokens": 999999, "output_tokens": 1}, "response_ms": 1000}
...
class TestTokenCounterSessionManagement:
    ...
    def test_multiple_updates_accumulate(self):
        ...
        # First update
        response1 = {"prompt_token_count": 100, "candidates": [{"token_count": 200}], "total_latency": 0.5}
        counter.update(response1)

        # Second update
        response2 = {"prompt_token_count": 150, "candidates": [{"token_count": 250}], "total_latency": 0.6}
