...
class TestCommandsNotStubs:
    ...
    def test_command_is_not_stub(self, func_name: str) -> None:
        ...
        result = _run_python(
            f"from ollama_cmd.root import {func_name}; "
            f"import inspect; "
    ...
    def test_pull_delegates_to_module(self) -> None:
        ...
        result = _run_python(
            "from ollama_cmd.root import cmd_pull; import inspect; "
    ...
    def test_config_delegates_to_module(self) -> None:
        ...
        result = _run_python(
            "from ollama_cmd.root import cmd_config; import inspect; "
    ...
    def test_status_delegates_to_module(self) -> None:
        ...
        result = _run_python(
            "from ollama_cmd.root import cmd_status; import inspect; "
...
class TestPullCommand:
    ...
    def test_handle_pull_importable(self) -> None:
        result = _run_python("from ollama_cmd.pull import handle_pull; print(callable(handle_pull))")
        assert result.stdout.strip() == "True"
    ...
    def test_pull_no_stub_text(self) -> None:
        result = _run_python(
            "from ollama_cmd.pull import handle_pull; import inspect; "
...
class TestConfigCommand:
    ...
    def test_handle_config_importable(self) -> None:
        result = _run_python("from ollama_cmd.config import handle_config; print(callable(handle_config))")
        assert result.stdout.strip() == "True"
...
class TestStatusCommand:
    ...
    def test_handle_status_importable(self) -> None:
        result = _run_python("from ollama_cmd.status import handle_status; print(callable(handle_status))")
        assert result.stdout.strip() == "True"
    ...
    def test_status_no_stub_text(self) -> None:
        result = _run_python(
            "from ollama_cmd.status import handle_status; import inspect; "
